  ...
  return (
    <Card className={cn("p-2  grid grid-cols-1 md:grid-cols-2 gap-3", props.className)}>
      <Input
        ...
        defaultValue={getValues().propertyFeature?.bedrooms ? getValues().propertyFeature.bedrooms.toString() : ""}
      />
      ...
      <Input
        ...
        defaultValue={getValues().propertyFeature?.bathrooms ? getValues().propertyFeature.bathrooms.toString() : ""}
      />
      <Input
        ...
        defaultValue={
          getValues().propertyFeature?.parkingSpots ? getValues().propertyFeature.parkingSpots.toString() : ""
        }
      />
      ...
      <Input
        ...
        defaultValue={getValues().propertyFeature?.area ? getValues().propertyFeature.area.toString() : ""}
      />
